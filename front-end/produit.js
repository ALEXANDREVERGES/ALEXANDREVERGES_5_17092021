//Création de key localstorage pour sstocker les articles
...
function afficher(name0, price0, imageUrl0, description0){
    console.log('name0:' + name0);
    console.log('price0:' + price0);
    console.log('imageUrl0:' + imageUrl0);
    console.log('description0:' + description0);   
};
afficher('Norbert','2900','http://localhost:3000/images/teddy_1.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');

function afficher1(name1, price1, imageUrl1, description1){
    console.log('name1:' + name1);
    console.log('price1:' + price1);
    console.log('imageUrl1:' + imageUrl1);
    console.log('description1:' + description1);   
};
afficher1('Arnold','3900','http://localhost:3000/images/teddy_2.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');

function afficher2(name2, price2, imageUrl2, description2){
    console.log('name2:' + name2);
    console.log('price2:' + price2);
    console.log('imageUrl2:' + imageUrl2);
    console.log('description2:' + description2);   
};
afficher2('Lenny and Carl','5900','http://localhost:3000/images/teddy_3.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');



function afficher3(name3, price3, imageUrl3, description3){
    console.log('name3:' + name3);
    console.log('price3:' + price3);
    console.log('imageUrl3:' + imageUrl3);
    console.log('description3:' + description3);   
};
afficher3('Gustav','4500','http://localhost:3000/images/teddy_4.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');



function afficher4(name4, price4, imageUrl4, description4){
    console.log('name4:' + name4);
    console.log('price4:' + price4);
    console.log('imageUrl4:' + imageUrl4);
    console.log('description4:' + description4);   
};
afficher4('Garfunkel','5500','http://localhost:3000/images/teddy_5.jpg','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.');
...
let res = fetch('http://localhost:3000/api/teddies/$(_id)');

fetch('http://localhost:3000/api/teddies')
.then(res => res.json())
.then(data => carte = data[0]._id)
